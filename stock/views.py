...
# ! admin panelinden oluşturmuş olduğum kullanıcı rolü gruplarını kullanabilmek için DjangoModelPermissions'ı import edip kullanabiliriz fakat kendi permiisions'ımızı yazdığımız için onu çağırıp permission_classes kısmına onu yazıyorum
